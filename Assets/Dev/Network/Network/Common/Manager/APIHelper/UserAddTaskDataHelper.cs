...
public class UserAddTaskDataHelper : MonoBehaviour
{
    public static byte[] CreateFBAddTaskDataRequestBody(AddTaskDataRequestBody body)
    {
        ...
        var ApiRequest = RequestAddTaskData.CreateRequestAddTaskData(builder, 
...
public class AddTaskDataRequestBody
{
