...
public class UserFinishItemHelper : MonoBehaviour
{
    public static byte[] CreateFbFinishItemRequestBody(FinishItemRequestBody body)
    {
        ...
        var ApiRequest = RequestFinishItem.CreateRequestFinishItem(builder,
            body.TaskId,
            ...
            body.SpeedRate,
            body.ProductId,
            RequestFinishItem.CreateCommonResourceVector(builder, commonResource),
            RequestFinishItem.CreateWorkerPossitionVector(builder, workerPosition),
            RequestFinishItem.CreateVassalPossitionVector(builder, vassalPosition)
...
public class FinishItemRequestBody
{
    public int TaskId;
