...
public class UserFinishUpgradeHelper : MonoBehaviour
{
    public static byte[] CreateFbFinishUpgradeRequestBody(FinishUpgradeRequestBody body)
    {
        ...
        var ApiRequest = RequestFinishUpgrade.CreateRequestFinishUpgrade(builder,
            body.TaskId,
            ...
            body.SpeedRate,
            body.ProductId,
            RequestFinishUpgrade.CreateCommonResourceVector(builder, commonResource),
            RequestFinishUpgrade.CreateWorkerPossitionVector(builder, workerPosition),
            RequestFinishUpgrade.CreateVassalPossitionVector(builder, vassalPosition)
...
public class FinishUpgradeRequestBody
{
    public int TaskId;
