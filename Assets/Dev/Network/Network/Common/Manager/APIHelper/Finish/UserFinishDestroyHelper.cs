...
public class UserFinishDestroyHelper : MonoBehaviour
{
    public static byte[] CreateFbFinishDestroyRequestBody(FinishDestroyRequestBody body)
    {
        ...
        var ApiRequest = RequestFinishDestroy.CreateRequestFinishDestroy(builder,
            body.TaskId,
            ...
            body.SpeedRate,
            body.ProductId,
            RequestFinishDestroy.CreateCommonResourceVector(builder, commonResource),
            RequestFinishDestroy.CreateWorkerPossitionVector(builder, workerPosition),
            RequestFinishDestroy.CreateVassalPossitionVector(builder, vassalPosition)
...
public class FinishDestroyRequestBody
{
    public int TaskId;
